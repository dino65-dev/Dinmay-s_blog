            ...
            <div className="grid grid-cols-2 gap-6">
              <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg p-6">
                ...
                <form onSubmit={handleMarkdownSubmit}>
                  ...
                  <div className="mb-4">
                    <Label htmlFor="md-image">Featured Image</Label>
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        >
                          <div className="flex items-center justify-center gap-2 px-4 py-2 border-2 border-dashed border-gray-300 dark:border-gray-600 rounded-lg hover:border-blue-500 dark:hover:border-blue-400 transition-colors bg-gray-50 dark:bg-gray-800">
                            ...
                            <span className="text-sm font-medium">
                              {mdImageUploading ? 'Uploading...' : 'Upload Image from Computer'}
                            </span>
                          </div>
                        </Label>
                        <input
                          ...
                          onChange={(e) => {
                            const file = e.target.files?.[0];
                            if (file) {
                              handleImageUpload(file, setMdImage, setMdImageError, setMdImageUploading);
                            }
                          }}
              ...
              <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg p-6">
                <h2 className="text-xl font-bold mb-6 text-gray-900 dark:text-white">Live Preview</h2>
          ...
          <TabsContent value="admin">
            <div className="bg-white border border-gray-200 rounded-lg p-6">
              ...
              <form onSubmit={handleAdminSubmit}>
                ...
                <div className="mb-4">
                  <Label htmlFor="admin-image">Featured Image</Label>
                  ...
                  <div className="mt-2 space-y-2">
                    <div className="flex items-center gap-2">
                      ...
                      >
                        <div className="flex items-center justify-center gap-2 px-4 py-2 border-2 border-dashed border-gray-300 dark:border-gray-600 rounded-lg hover:border-blue-500 dark:hover:border-blue-400 transition-colors bg-gray-50 dark:bg-gray-800">
                          ...
                          <span className="text-sm font-medium">
                            {adminImageUploading ? 'Uploading...' : 'Upload Image from Computer'}
                          </span>
                        </div>
                      </Label>
                      <input
                        ...
                        onChange={(e) => {
                          const file = e.target.files?.[0];
                          if (file) {
                            handleImageUpload(file, setAdminImage, setAdminImageError, setAdminImageUploading);
                          }
                        }}
                    ...
                    <Input
                      ...
                      placeholder="Or paste image URL: https://example.com/image.jpg"
                      className={`${adminImageError ? 'border-yellow-500' : ''}`}
                      disabled={adminImageUploading}
                    />
                  </div>
