    ...
    <div className="min-h-screen bg-cream dark:bg-gray-950 transition-colors duration-300">
      ...
      <section className="py-20 px-6 md:px-12">
        <div className="max-w-5xl mx-auto">
          <div className="bg-white dark:bg-gray-900 rounded-3xl p-8 md:p-12 text-center">
            ...
            <h2 className="text-3xl md:text-4xl font-semibold text-amber-500 mb-6">
              Get in Touch
            </h2>
            ...
            <div className="flex flex-wrap justify-center gap-4">
              ...
              <Link
                to="/"
                className="inline-flex items-center gap-3 px-8 py-4 border border-gray-300 dark:border-gray-700 text-gray-700 dark:text-gray-300 rounded-full font-medium hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors"
              >
                View Blog Posts
      ...
      <nav className="fixed bottom-6 left-1/2 -translate-x-1/2 z-50">
        <div className="flex items-center gap-1 px-2 py-2 bg-gray-900/95 dark:bg-gray-800/95 backdrop-blur-lg rounded-full shadow-2xl">
          ...
          <Link to="/about" className="px-5 py-2.5 bg-amber-500 text-white text-sm font-medium rounded-full">
            About
          </Link>
